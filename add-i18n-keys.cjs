...
const newKeys = [
  ...
  `      "disclosure.image.body": "Your image will be sent to the cloud for analysis. It is processed in-session only and is never used to train AI models. See our Privacy Policy for details.",`,
  `      "disclosure.ai.title": "AI Analysis",`,
  `      "disclosure.ai.body": "Your project data will be sent to the cloud for analysis. Data is processed under contractual necessity and is never used for model training.",`,
