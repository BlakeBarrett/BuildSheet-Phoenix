...
const DISCLOSURE_MESSAGES: Record<DisclosureType, { icon: string; title: string; body: string }> = {
  'image-upload': {
    ...
    body: 'Your image will be sent to the cloud for analysis. It is processed in-session only and is never used to train AI models. See our Privacy Policy for details.',
  },
  'ai-analysis': {
    icon: 'psychology',
    title: 'AI Analysis',
    body: 'Your project data will be sent to the cloud for analysis. Data is processed under contractual necessity and is never used for model training.',
  },
};
